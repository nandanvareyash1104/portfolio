...
const Home = () => {
  return (
    <div
      name="Home"
      className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-10 text-white"
    >
      <div className="flex flex-col md:flex-row items-center w-full h-screen">
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left order-2 md:order-1">
          ...
          <p className="text-md md:text-lg leading-relaxed text-justify">
            I am a passionate React.js Developer dedicated to crafting
            high-performance, scalable, and user-friendly web applications. With
            a strong foundation in React, TypeScript, and modern front-end
            technologies, I specialize in building interactive and accessible
            UIs that enhance user experience.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:justify-between">
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center md:justify-start space-x-5 mt-2">
                ...
                <a
                  href="https://github.com/nandanvareyash1104"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center md:justify-start space-x-5 mt-2">
                ...
                <SiRedux className="text-4xl hover:scale-110 duration-200 border-[2px] p-2 rounded-full" />
              </div>
            </div>
          </div>
        </div>
